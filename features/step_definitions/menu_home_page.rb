Dado('que eu esteja na página home') do
  ...
  #Aqui invocamos a função load do arquivo commum_page.rb // 
  #Lembrando que a função load é algo já de uma das bibliotecas que utilizamos.
  commum.load
end
...
Então('sou direcionado para a sessão {string}') do |sessao_name|
  #Aqui invocamos a função validate_test passando o parametro, 
  #essa função foi definida la no arquivo menu_home_page.rb 
  #dentro da pasta pages // Lembrando que essa função foi criado por nos
